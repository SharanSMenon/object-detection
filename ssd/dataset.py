...
#                 cur_pt = cur_pt / width if i % 2 == 0 else cur_pt / height
    ...
    def __getitem__(self, index: int):
        ...
        bndboxes, clses, difficulties = self.transform_annotation_to_bbox(target)

        image, bboxes, labels, difficulties = transform(img, bndboxes, clses, difficulties, "TRAIN" if self.train else "TEST")
